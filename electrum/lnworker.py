...
class LNWallet(LNWorker):
    ...
    @log_exceptions
    async def open_channel_just_in_time(self, next_peer, next_amount_msat_htlc, next_cltv_expiry, payment_hash, next_onion):
        ...
        htlc = next_peer.send_htlc(next_chan, payment_hash, next_amount_msat_htlc, next_cltv_expiry, next_onion)
